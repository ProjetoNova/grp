<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tempoGasto.aspx.cs" Inherits="NovaProjectWeb.View.pages.index" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tempo Gasto Por Atividade</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
